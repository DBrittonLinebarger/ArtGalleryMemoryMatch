...
/**
 * contains the methods for adding tiles to the game grid, flipping tiles,
 * calculating number of turns and matches
 */
public class GameLogic {
  ...
  /**
   * contains logic for determining status of tiles (face up/face down), setting score data
